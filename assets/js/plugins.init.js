...
try {
    const Default = {
        defaultTabId: null,
        activeClasses: 'text-white bg-yellow-500',
        inactiveClasses: 'hover:text-yellow-500 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-slate-800',
        onShow: () => { }
    }
...
try {
    const Default = {
        alwaysOpen: false,
        activeClasses: 'bg-gray-50 dark:bg-slate-800 text-yellow-500',
